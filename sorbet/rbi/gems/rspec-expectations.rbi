...
class InvalidName___Class_0x00___Differ_22
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_23
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_24
